...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddExportServices(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IExportStage, InventoryObjectExportStage>();
        ...
        services.AddSingleton<IExportStage, MappingImplementationTrackerStage>();
        services.AddSingleton<IExportStage, DomainExtractorCoverageStage>();
